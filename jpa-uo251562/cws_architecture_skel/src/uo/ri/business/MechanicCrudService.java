...
public interface MechanicCrudService {
	...
	List<MechanicDto> findAllMechanicsWithRepuestos() throws BusinessException;

	List<MechanicDto> findAllMechanicsWithIntervencionesLastYear() throws BusinessException;
