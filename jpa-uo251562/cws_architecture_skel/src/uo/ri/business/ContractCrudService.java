...
public interface ContractCrudService {
	 ...
	 * that will be marked as extinguished and the compensation computed. The
	 * start date of the contract will be set to the first day of the month
	 * passed as startDate.
	 * 
	 * @param c, the contract dto. Only the fields mechanicId, typeId,
	 *        categoryId, startDate, endDate (if not null) and yearBaseSalary
	 *        will be taken into account. The rest will be ignored for this
	 *        operation.
	 * 
	 * @throws BusinessException if: - the contract type does not exist, or -
	 *                           the mechanic does not exist, or - the contract
	 *                           category does not exist, or - the given end
	 *                           date (if any) is not after the start date, or -
	 ...
	 * 
	 * Just the end date (if not null in the dto) and the year base salary will
	 * be updated. The id is used to locate the mechanic, the rest of fields in
	 ...
	 *                           contract is no longer active, or - the base
	 *                           year salary is a negative value, or - the
	 *                           endDate, being not null, is before the start
	 *                           date
	 */
	 ...
	 * @throws BusinessException if: - the contract does not exist, or - the
	 *                           mechanic have had interventions during the
	 *                           contract period, or - the are payrolls
	 ...
	 * 
	 * @throws BusinessException if: - the contract does not exist, or - the
	 *                           contract is not active, or - the endDate passed
	 *                           is before the start date of the contract
	 */
	void finishContract(Long id, Date endDate) throws BusinessException;

	/**
	 * @param id, of the contract
	 * @return the dto for the contract with all the fields filled, or null if
