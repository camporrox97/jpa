...
import uo.ri.business.impl.mechanic.command.FindAllMechanicsWithIntervencionesLastYear;
import uo.ri.business.impl.mechanic.command.FindAllMechanicsWithRepuestos;
...
public class MechanicCrudServiceImpl implements MechanicCrudService {
	...
	@Override
	public List<MechanicDto> findAllMechanicsWithRepuestos() throws BusinessException {
		return executor.execute(new FindAllMechanicsWithRepuestos());

	}

	@Override
	public List<MechanicDto> findAllMechanicsWithIntervencionesLastYear() throws BusinessException {
		
		return executor.execute(new FindAllMechanicsWithIntervencionesLastYear());
