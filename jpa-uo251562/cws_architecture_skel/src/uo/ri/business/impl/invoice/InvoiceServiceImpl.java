...
import uo.ri.business.impl.invoice.command.FindAllInvoiceExam;
import uo.ri.business.impl.invoice.command.PagoDudoso;
...
public class InvoiceServiceImpl implements InvoiceService {
	...
	@Override
	public List<InvoiceDto> findAllInvoiceExam() throws BusinessException {
		
		return executor.execute( new FindAllInvoiceExam());

	}

	@Override
	public void pagoDudoso() throws BusinessException {
		
		 executor.execute( new PagoDudoso());
