...
import uo.ri.ui.cash.action.ListarFacturasExamenAction;
import uo.ri.ui.cash.action.ListarMediosDePagoAction;
import uo.ri.ui.cash.action.PagoDudosoAction;
	...
	private static class MainMenu extends BaseMenu {
		MainMenu() {
			menuOptions = new Object[][] { 
				...
				{ "Listar facturas examen",             ListarFacturasExamenAction.class},
				{  "Pasar a pago dudoso",               PagoDudosoAction.class},
				{  "Listar medios de pago de un cliente",  ListarMediosDePagoAction.class}
			};
		}
	}
